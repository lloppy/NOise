...
//                            .newLatLngZoom(defaultLocation, DEFAULT_ZOOM.toFloat()))
    ...
    private fun getCurrentData() {
        ...
        var tv_timeStamp = findViewById<TextView>(R.id.tv_timeStamp)
        ...
        GlobalScope.launch(Dispatchers.IO) {
            try {
                val response = api.getMapPoint().awaitResponse()
...
//                        tv_textView.text = data.lat.toString()
//                        tv_timeStamp.text = data.DeBe.toString()
